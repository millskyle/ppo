...
if __name__=='__main__':
    ...
    ppo = PPO(policy=policy, old_policy=old_policy, gamma=0.95, epsilon=0.2, c_1=1.0, c_2=0.1)
        ...
        for iteration in range(ITERATIONS):
            ...
            if iteration > 0 and iteration % 10 == 0:
                ...
                for epoch in range(10):
                    sample_indices = np.random.randint(low=0, high=observations.shape[0], size=512)
